# Salone Culture App (Jetpack Compose)
Salone Culture App is a sample culture0026heritage app for Sierra Leone, built with
...
Package [`com.example.saloneculture.ui`][1]

[`Salone Culture AppApp.kt`][2] arranges the different screens in the `NavDrawerLayout`. 

[`Salone Culture AppNavGraph.kt`][3] configures the navigation routes and actions in the app. 

[1]: app/src/main/java/com/example/saloneculture/ui
[2]: app/src/main/java/com/example/saloneculture/ui/Salone Culture AppApp.kt
[3]: app/src/main/java/com/example/saloneculture/ui/Salone Culture AppNavGraph.kt

### Main article list

Package [`com.example.saloneculture.ui.home`][4]
...
[4]: app/src/main/java/com/example/saloneculture/ui/home

### Article detail

Package [`com.example.saloneculture.ui.article`][5]
...
[5]: app/src/main/java/com/example/saloneculture/ui/article
[6]: app/src/main/java/com/example/saloneculture/ui/theme/Type.kt

### Interests screen

Package [`com.example.saloneculture.ui.interests`][7]
...
[7]: app/src/main/java/com/example/saloneculture/ui/interests
[8]: app/src/main/java/com/example/saloneculture/ui/interests/SelectTopicButton.kt

### AppWidget powered by Glance

Package [`com.example.saloneculture.glance`][9]
...
[9]: app/src/main/java/com/example/saloneculture/glance

### Data

The data in the sample is static, held in the `com.example.saloneculture.data` package.
...
## Salone Culture App for every screen

<img src="screenshots/jetnews_all_screens.png" alt="Screenshot">

We recently updated Salone Culture App to enhance its behavior across all mobile devices, both big and small.
Salone Culture App already had support for “traditional” mobile screens, so it was tempting to describe all of
...
Salone Culture App is working better than ever on large screens, but also on small screens too.
